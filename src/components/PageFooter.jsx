...
export const Footer = () => {
    ...
    location3 = location3.replaceAll("\n", "<br/>");
				...
				<div className="grid row-gap-10 mb-8 lg:grid-cols-3">
					<div className="grid lg:grid-cols-4 grid-cols-1 gap-24 row-gap-8 lg:col-span-3 md:grid-cols-4">
						...
						<div>
							...
							<ul className="mt-2 space-y-2">
								<li>
									<a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200" dangerouslySetInnerHTML={{ __html: location1 }}></a>
								</li>
								<li>
									<a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200" dangerouslySetInnerHTML={{ __html: location2 }}></a>
								</li>
							</ul>
						</div>
						<div>
							...
							<ul className="mt-2 space-y-2">
								<li>
									<a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200" dangerouslySetInnerHTML={{ __html: location3 }}></a>
								</li>
								<li>
									<a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200" dangerouslySetInnerHTML={{ __html: location4 }}></a>
								</li>
							</ul>
						</div>
					</div>
