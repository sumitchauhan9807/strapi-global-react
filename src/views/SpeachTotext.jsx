...
import texttospeachu from "../assets/images/texttospeachu.gif"
    ...
    <div className="flex items-center justify-center p-10 bg-gray-50 rounded-lg">     
      ...
      <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div className="flex-1 ">
            <img src={texttospeachu} alt="Robot" className="w-full h-full max-w-xl transition duration-300 transform hover:scale-105 hover:grayscale-0 grayscale" />
          </div>
          <div className="flex-2 p-6">
            <h3 className="text-blue-500 uppercase font-bold text-sm">Solution</h3>
            <h1 className="text-5xl font-semi-bold text-gray-800 mt-2 mb-4">Text to Speach</h1>
