            ...
            <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="grid items-center justify-center lg:grid-cols-2 grid-cols-1">
                    ...
                    <div className="flex-2 p-6">
                        ...
                        <h1 className="text-5xl font-semi-bold text-gray-800 mt-2 mb-4">Acceleration of sales supported by Chatbot</h1>
                        <p className="text-gray-600 text-lg mb-4 font-sans">
                            Software product which automates call center together with Virtual AccSales services:
                        </p>
                ...
                </div><div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <div>
