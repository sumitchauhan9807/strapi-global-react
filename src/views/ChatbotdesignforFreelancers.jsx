...
import chatbotfreelacer from "../assets/images/chatbotfreelacer.gif"


const FreelancerChatbot = () => {
    return (
            ...
            <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="grid items-center justify-center lg:grid-cols-2 grid-cols-1">
                    ...
                    <div className="flex-1 ">
                        <img src={chatbotfreelacer} alt="Robot" className="w-full h-full max-w-xl transition duration-300 transform hover:scale-105 hover:grayscale-0 grayscale" />
                    </div>
                    <div className="flex-2 p-6">
                        <h3 className="text-blue-500 uppercase font-bold text-sm">Solution</h3>
                        <h1 className="text-5xl font-semi-bold text-gray-800 mt-2 mb-4">Chatbot design for freelance developers</h1>
                        <p className="text-gray-600 text-lg mb-4 font-sans">
                            Software product which automates call center together with Virtual FreelancerChatbot services:
                        </p>
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              <img src="https://s.kompaas.org/assets/img/c-mf__man-with-notebook.svg" alt="" />
            </div>
              ...
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                <form>
                  ...
                  <div className="mt-4 mb-2 sm:mb-4">
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-gray-800 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                    >
                      Subscribe
                    </button>
                  </div>
...
export default FreelancerChatbot;
