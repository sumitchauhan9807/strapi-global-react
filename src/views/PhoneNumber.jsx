      ...
      <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex items-center justify-center">
          ...
          <div className="flex-2 p-6">
            ...
            <h1 className="text-5xl font-semi-bold text-gray-800 mt-2 mb-4">USA phone numbers</h1>
            <p className="text-gray-600 text-lg mb-4 font-sans ">
              KOMPaaS virtual numbers for connecting IP telephony in the office.
            </p>
            ...
            <div className="flex items-center gap-6 mt-6 ">
              <div className="border-2 shadow-2xl  px-6 py-4 rounded-lg gap-3"> <span className="text-xl font-sans uppercase text-gray-800">+44 Start $0.99/mo</span>
